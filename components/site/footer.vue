            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="mb-4 text-center">
                        <img src="/assets/images/apple-touch-icon.png" alt="" width="" class="logo-inverse img-fluid ">
                        <div class="mt-4">
                            <p>Empowering dreams, igniting futures.</p>
                            <!-- social media -->
                            <!-- <div class="fs-4 mt-4">
            ...
            <div class="row align-items-center g-0 border-top py-2 mt-6">
                ...
                <div class="col-lg-4 col-md-5 col-12">
                    <span>© <span id="copyright2">
                        ...
                        </span> Ikamvelihle Youth Development</span>
                </div>
